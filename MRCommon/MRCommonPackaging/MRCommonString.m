...
//    NSString *mobile = @"^1(3[0-9]|4[579]|5[0-9]|6[6]|7[0-9]|8[0-9])\\d{8}$";
    NSString *mobile = @"^1([3-9][0-9])\\d{8}$";
    /**
     * 中国移动：China Mobile
     * 134,135,136,137,138,139,147,150,151,152,157,158,159,182,183,184,187,188,147,178,1705
     */
    NSString *CM = @"(^1(3[4-9]|4[579]|5[0-27-9]|7[0-9]|8[2-478])\\d{8}$)|(^1705\\d{7}$)";
    /**
     * 中国联通：China Unicom
     * 130,131,132,155,156,185,186,145,166,171,176,1709
     */
    NSString *CU = @"(^1(3[0-2]|4[5]|5[56]|6[6]|7[16]|8[56])\\d{8}$)|(^1709\\d{7}$)";
    /**
     * 中国电信：China Telecom
