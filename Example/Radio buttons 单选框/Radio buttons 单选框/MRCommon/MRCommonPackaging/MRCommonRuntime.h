...
/**
 获取类名                   Get the name of the class
...
/**
 获取成员变量                          Access to the member variable
...
/**
 获取属性列表 (私有属性 + 在延展中定义的属性) Gets an attribute list (private + defined in extended attribute)
 @param class   相应类                  The corresponding class
...
/**
 获取对象方法列表：getter, setter, 对象方法等。但不能获取类方法  To obtain a list object method: getters, setters, object methods, etc.But it can't get class methods
...
/**
 获取协议列表                             To obtain a list agreement
...
/**
 添加新的方法                                  Add a new method in runtime
